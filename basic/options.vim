...
" ===
" === centralized diagnostic signs
" ===
let g:osv_sign_error   = ''
let g:osv_sign_warning = ''
let g:osv_sign_info    = ''
let g:osv_sign_hint    = ''

" ===
" === file header defaults (overridable in custom_modules.vim)
" ===
if !exists('g:osv_copyright_holder')
    let g:osv_copyright_holder = 'Concordia NAVlab'
endif
