...
elseif g:osv_file_explorer == 'defx'
    call osv_ultis#plug#add('kristijanhusak/defx-git', {'lazy':1,
                \'hook_source':'source $CONF_PATH/plug_conf/before/defx_git_config.vim'})
    call osv_ultis#plug#add('kristijanhusak/defx-icons', {'lazy':1,
    ...
    call osv_ultis#plug#add('Shougo/defx.nvim', s:defx_nvim_config)
elseif g:osv_file_explorer == 'fern'
    call osv_ultis#plug#add('lambdalisue/nerdfont.vim', {'lazy':1,
                \})
    call osv_ultis#plug#add('lambdalisue/fern-renderer-nerdfont.vim', {'lazy':1,
                \'depends':['nerdfont.vim'],
                \})
    call osv_ultis#plug#add('lambdalisue/fern-hijack.vim', {'lazy':1,
                \})
    call osv_ultis#plug#add('lambdalisue/fern-git-status.vim', {'lazy':1,
                \})
    call osv_ultis#plug#add('lambdalisue/fern.vim', {'lazy':1,
                \'on_map':'<leader>t',
                \'on_cmd':'Fern',
...
elseif g:osv_file_explorer == 'vimfiler'
    call osv_ultis#plug#add('Shougo/unite.vim', {'lazy':1,
                \})
    call osv_ultis#plug#add('Shougo/vimfiler.vim', {'lazy':1,
                \'on_map':'<leader>t',
