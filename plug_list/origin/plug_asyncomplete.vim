...
" === sources
" ===
call osv_ultis#plug#add('prabirshrestha/asyncomplete-buffer.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-buffer.vim')
call osv_ultis#plug#add('prabirshrestha/asyncomplete-file.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-file.vim')
call osv_ultis#plug#add('prabirshrestha/asyncomplete-emoji.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-emoji.vim')

if executable('look')
    call osv_ultis#plug#add('htlsne/asyncomplete-look', {'lazy':1,
...
if g:os_architect != 'aarch64'
    if g:os_name == 'Linux'
        call osv_ultis#plug#add('lee-shun/asyncomplete-tabnine.vim', { 'lazy':1,
                    \'build': './install.sh',
                    \})
...
if g:osv_snip == 'ultisnips'
    call osv_ultis#plug#add('prabirshrestha/asyncomplete-ultisnips.vim', {'lazy':1,
                \})
...
" linter
if g:osv_linter == 'ale'
    call osv_ultis#plug#add('andreypopp/asyncomplete-ale.vim', {'lazy':1,
                \})
...
if g:osv_lsp == 'vim-lsp'
    call osv_ultis#plug#add('prabirshrestha/asyncomplete-lsp.vim', {'lazy':1,
                \})
...
elseif g:osv_lsp == 'vim-lsc' || g:osv_lsp == 'lcn'
    ...
    call osv_ultis#plug#add('yami-beta/asyncomplete-omni.vim', {'lazy':1
                \})
    call add(s:asyncomplete_conf.depends, 'asyncomplete-omni.vim')
endif

call osv_ultis#plug#add('prabirshrestha/asyncomplete.vim', s:asyncomplete_conf)
