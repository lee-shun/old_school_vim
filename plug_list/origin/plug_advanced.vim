...
if g:osv_complete_engine == 'coc' || g:osv_lsp == 'vim-lsp'
    if executable('ccls')
        call osv_ultis#plug#add('jackguo380/vim-lsp-cxx-highlight', {'lazy':1,
                    \'on_ft':['cpp', 'c'],
...
call osv_ultis#plug#add('chxuan/cpp-mode', {'lazy':1,
            \'on_ft':['cpp'],
            \})

if g:osv_repo_source !=# 'mirror'
    call osv_ultis#plug#add('ilyachur/cmake4vim', {'lazy':1,
...
if g:osv_complete_engine != 'coc'
    call osv_ultis#plug#add('voldikss/vim-translator', {'lazy':1,
...
call osv_ultis#plug#add('sbdchd/neoformat', {'lazy':1,
            \'on_cmd':'Neoformat',
            \'hook_add':'command! Format Neoformat'
            \})

call osv_ultis#plug#add('preservim/vim-markdown', {'lazy':1,
            \'on_ft' :['markdown'],
            \})
...
if (g:os_name == 'Linux' && g:os_architect == 'x86_64') || (g:os_name == 'Windows')
    if osv_ultis#check_env#check_vim_ver(801) || osv_ultis#check_env#check_nvim_ver('nvim')
        call osv_ultis#plug#add('iamcco/markdown-preview.nvim', {'lazy':1,
                    \'on_ft' :['markdown'],
...
call osv_ultis#plug#add('ferrine/md-img-paste.vim',{'lazy':1,
            \'on_ft':'markdown',
            \'hook_source':'source $CONF_PATH/plug_conf/before/mkd_paste_img_conf.vim'
            \})

if executable('latexmk')
    call osv_ultis#plug#add('lervag/vimtex', {'lazy':1,
                \'on_ft':['tex'],
...
if (g:os_name == 'Linux') && (executable('roscore'))
    call osv_ultis#plug#add('taketwo/vim-ros', {'lazy':1,
                \'on_ft':'rosmsg',
                \'on_cmd':'Roscd'
                \})
else
...
call osv_ultis#plug#add('edersonferreira/open.vim', {'lazy':1,
            \'on_event':'BufReadPost',
            \'hook_source':'source $CONF_PATH/plug_conf/before/open_conf.vim',
            \})

call osv_ultis#plug#add('kkoomen/vim-doge', {'lazy':1,
            \'on_cmd':'DogeGenerate',
