...
" === sources
" ===
call dein#add('lee-shun/asyncomplete-buffer.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-buffer.vim')
call dein#add('lee-shun/asyncomplete-file.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-file.vim')
call dein#add('lee-shun/asyncomplete-emoji.vim', {'lazy':1,
            \})
call add(s:asyncomplete_conf.depends, 'asyncomplete-emoji.vim')

if executable('look')
    call dein#add('lee-shun/asyncomplete-look', {'lazy':1,
...
if has('python3') && dein#tap('ultisnips')
    call dein#add('lee-shun/asyncomplete-ultisnips.vim', {'lazy':1,
                \})
...
" linter
if g:osv_linter == 'ale'
    call dein#add('lee-shun/asyncomplete-ale.vim', {'lazy':1,
                \})
...
if g:osv_lsp == 'vim-lsp'
    call dein#add('lee-shun/asyncomplete-lsp.vim', {'lazy':1,
                \})
...
elseif g:osv_lsp == 'vim-lsc' || g:osv_lsp == 'lcn'
    ...
    call dein#add('lee-shun/asyncomplete-omni.vim', {'lazy':1
                \})
    call add(s:asyncomplete_conf.depends, 'asyncomplete-omni.vim')
endif

call dein#add('lee-shun/asyncomplete.vim', s:asyncomplete_conf)
