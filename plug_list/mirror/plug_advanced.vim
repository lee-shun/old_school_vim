...
if g:osv_complete_engine != 'coc'
    call dein#add('lee-shun/vim-translator', {'lazy':1,
...
if g:osv_snip != 'none'
    call dein#add('lee-shun/vim-snippets', {'lazy':1,
                \'on_event':'InsertEnter'
                \})
endif

if g:osv_snip == 'ultisnips'
    call dein#add('lee-shun/ultisnips', {'lazy':1,
...
call dein#add('lee-shun/neoformat', {'lazy':1,
            \'on_cmd':'Neoformat',
            \'hook_add':'command! Format Neoformat'
            \})

call dein#add('lee-shun/vim-markdown', {'lazy':1,
            \'on_ft' :['markdown'],
            \})

if (g:os_name == 'Linux' && g:os_architect == 'x86_64') || (g:os_name == 'Windows')
    if has('nvim') || v:version >= 801
        call dein#add('lee-shun/markdown-preview.nvim', {'lazy':1,
                    \'on_ft' :['markdown'],
...
call dein#add('lee-shun/md-img-paste.vim',{'lazy':1,
            \'on_ft':'markdown',
            \'hook_source':'source $CONF_PATH/plug_conf/before/mkd_paste_img_conf.vim'
            \})

if executable('latexmk')
    call dein#add('lee-shun/vimtex', {'lazy':1,
                \'on_ft':['tex'],
...
if (g:os_name == 'Linux') && (executable('roscore'))
    call dein#add('lee-shun/vim-ros', {'lazy':1,
                \'on_ft':'rosmsg',
                \'on_cmd':'Roscd'
                \})
else
...
call dein#add('lee-shun/open.vim', {'lazy':1,
            \'on_event':'BufReadPost',
            \'hook_source':'source $CONF_PATH/plug_conf/before/open_conf.vim',
            \})

call dein#add('lee-shun/vim-doge', {'lazy':1,
            \'on_cmd':'DogeGenerate',
