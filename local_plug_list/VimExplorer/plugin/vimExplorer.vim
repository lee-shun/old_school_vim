...
let VEConf.filePanelHotkey.newFile         = 'a'
let VEConf.filePanelHotkey.newDirectory    = 'A'
let VEConf.filePanelHotkey.switchPanel     = '<c-tab>'
let VEConf.filePanelHotkey.quitVE          = 'q'
let VEConf.filePanelHotkey.toggleHidden    = '<c-h>'
...
"single file actions
let VEConf.filePanelHotkey.rename          = 'rn'
let VEConf.filePanelHotkey.yankSingle      = 'yy'
let VEConf.filePanelHotkey.cutSingle       = 'dd'
let VEConf.filePanelHotkey.showYankList    = 'yl'
let VEConf.filePanelHotkey.deleteSingle    = 'df'
let VEConf.filePanelHotkey.deleteSingleF   = 'dF'
let VEConf.filePanelHotkey.openPreview     = 'ip'
let VEConf.filePanelHotkey.closePreview    = 'iP'
"mark
let VEConf.filePanelHotkey.toggleSelectUp  = 'K'
let VEConf.filePanelHotkey.toggleSelectDown= 'J'
...
let VEConf.filePanelHotkey.clearSelect     = 'cc'
...
let VEConf.filePanelHotkey.cutSelected     = 'sc'
let VEConf.filePanelHotkey.tabViewMulti    = 'se'
let VEConf.filePanelHotkey.paste           = 'pp'
